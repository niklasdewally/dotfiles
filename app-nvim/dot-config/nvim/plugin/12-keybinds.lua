...
vim.keymap.set("n", "]f", function() require('todo-comments').jump_next({keywords = { "FIX","FIXME","FIXIT","ERROR", "WARNING" }}) end, { desc = "Next fix comment" })
vim.keymap.set("n", "[f", function() require('todo-comments').jump_next({keywords = { "FIX","FIXME","FIXIT","ERROR", "WARNING" }}) end, { desc = "Previous fix comment" })
